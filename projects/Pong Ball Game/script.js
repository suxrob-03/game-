...
var colors = ["#1abc9c", "#67a2d5", "#21a742", "#f3bf14", "#9b59b6"];
...
var Game = {
  ...
  draw: function () {
    ...
    this.context.lineTo(this.canvas.width / 2, 160);
    ...
    this.context.fillText(
      (player_1.innerHTML = `${this.player.score.toString()}`),
    ...
    this.context.fillText(
      (player_2.innerHTML = `${this.ai.score.toString()}`),
      this.canvas.width / 0 - 0,
      200
    );
    ...
    this.context.font = "100px Courier";
